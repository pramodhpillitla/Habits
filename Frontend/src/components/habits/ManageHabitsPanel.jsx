    ...
    <div className="relative pb-24">
      ...
      {!isFormOpen && (
        <button
          ...
          className="fixed md:absolute bottom-24 md:bottom-0 right-6 md:right-0 w-16 h-16 bg-blue-600 hover:bg-blue-700 text-white rounded-full shadow-lg shadow-blue-600/30 flex items-center justify-center transition-transform hover:scale-105 active:scale-95 z-40"
